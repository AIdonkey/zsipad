    ...
    drawchart() {
      ...
      myChart.setOption({
        ...
        series: [{
          ...
          type: 'bar',
          color: 'blue',
          data: [this.reserdate[0].SYYYL0, this.reserdate[1].SYYYL0, this.reserdate[2].SYYYL0, this.reserdate[3].SYYYL0, this.reserdate[4].SYYYL0, this.reserdate[5].SYYYL0, this.reserdate[6].SYYYL0],
        }],
      });
    },
    reservation(data) {
